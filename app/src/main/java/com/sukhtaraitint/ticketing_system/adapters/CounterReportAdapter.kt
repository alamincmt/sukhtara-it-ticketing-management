...
import com.sukhtaraitint.ticketing_system.models.CounterReport

class CounterReportAdapter(var context: Context) : RecyclerView.Adapter<CounterReportAdapter.ViewHolder>() {

    var dataList = emptyList<CounterReport>()
    var onItemClickListener: OnItemClickListener? = null

    internal fun setDataList(dataList: List<CounterReport>) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CounterReportAdapter.ViewHolder {
    ...
    override fun onBindViewHolder(holder: CounterReportAdapter.ViewHolder, position: Int) {
